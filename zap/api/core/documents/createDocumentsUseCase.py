...
class CreateDocumentUseCase():
    ...
    update_bulk_use_case = UpdateBulkSignersUseCase()
    ...
    def execute(self, data, token):
        ...
        document_updated = self.document_repository.update_document(data_to_update, signers_to_update)
        updated_singers = self.update_bulk_use_case.execute(document_created, signers_to_update)
